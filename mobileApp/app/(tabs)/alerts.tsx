...
type Severity = 'critical' | 'elevated' | 'normal' | 'all';
    ...
    <SafeAreaView style={styles.safe} edges={['top']}>
      ...
      >
        ...
        <View style={styles.filters}>
          {(['all', 'critical', 'elevated', 'normal'] as Severity[]).map((f) => (
            <TouchableOpacity
              key={f}
              style={[
                styles.filterPill,
                filter === f && styles.filterPillActive,
                filter === f && f !== 'all' && { backgroundColor: severityBg[f as keyof typeof severityBg], borderColor: severityColor[f as keyof typeof severityColor] },
              ]}
              onPress={() => setFilter(f)}
            >
              <Text
                style={[
                  ...
                  filter === f && f !== 'all' && { color: severityColor[f as keyof typeof severityColor] },
                ]}
              >
        ...
        {/* Alert Cards */}
        {filtered.map((alert) => {
          const color = severityColor[alert.severity as keyof typeof severityColor];
          const bg = severityBg[alert.severity as keyof typeof severityBg];
          return (
